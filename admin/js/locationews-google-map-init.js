    ...
    jQuery(document).ready(function($) {
      ...
      "use strict";
        ...
        if ( 0 !== locationews_meta.latlng.length && locationews_meta.latlng != ( locationews_latitude + ',' + locationews_longitude ) ) {
        ...
        function placeLocationewsMarker( location, title, map, geocoder ) {
            ...
            if ( locationews_marker ) {
                ...
                locationews_marker = new google.maps.Marker({
                    ...
                    title:      '',
                    draggable:  true,
                    icon:       ( 0 !== locationews_map_init.icon.length ? locationews_map_init.icon : locationews_map_init.plugin_url + 'img/locationewsmerkkinormaali.png')
                });
            }
